        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header border-transparent">
                <h3 class="card-title">Latest level(l) data detected in fish pond</h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  $select=mysqli_query($con,"SELECT * from water_level order by id desc limit 10");
                  ...
                  ?>
                    <tr>
                     ...
                     <td><?php if ($row[1]<5) {
                        echo "<i class='fa-solid fa-turn-down' style='color:#023c27'></i> LOW";
                        }
                        else{
                          echo"<i class='fa-solid fa-level-up' style='color:#065c27'></i> GOOD";}?></td>
