        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header border-transparent">
                <h3 class="card-title">Latest Humidity data detected in atmosphere</h3>
                ...
                <div class="table-responsive">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><span class="badge badge-success"><?php echo"$row[2]"?></span></td>
                      ...
                      <?php if ($row[1]>26) {
                        ...
                        elseif ($row[1]<22){
                          ...
                          echo"<i class='fa-solid fa-droplet' style='color:#065c27'></i> GOOD";}
