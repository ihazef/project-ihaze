        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header border-transparent">
                <h3 class="card-title">Latest weight(kg) data detected in fish feeder</h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  $select=mysqli_query($con,"SELECT * from weight order by id desc limit 10");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo"$row[3]"?></div>
                      </td>
                      <td><?php if ($row[1]<3) {
