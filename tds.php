 ...
 <div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Abaut us</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open" class="nav-item">
            ...
            <a href="index.php" >
              ...
              <p>
                <i class="nav-icon fas fa-tachometer-alt"></i>Dashboard</p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pond_tempd.php" class="nav-link">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header border-transparent">
                <h3 class="card-title">Tds and Turbidity   detected in fish pond </h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  $select=mysqli_query($con,"SELECT * from solid order by id desc limit 10");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo"$row[1]"; if ($row[1]>80) {
                        echo "<i class='fa-solid fa-turn-up' style='color:#023c27'></i> ";
                        }
                        else{
                          echo"<i class='fa-solid fa-level-down' style='color:#065c27'></i>";}

                          ?></td>

                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo"$row[4]"?></div>
                      </td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo"$row[2]";
                        if ($row[2]>80) {
                          echo "<i class='fa-solid fa-turn-up' style='color:#023c27'></i> ";
                          }
                          else{
                            echo"<i class='fa-solid fa-level-down' style='color:#065c27'></i>";}?></div>

                      </td>

                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo"$row[5]"?></div>
                      </td></tr>
