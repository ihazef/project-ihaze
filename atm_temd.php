...
<div class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header border-transparent">
                <h3 class="card-title">Latest temperature data detected in atmosphere</h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  $select=mysqli_query($con,"SELECT * from atmospheric order by id desc limit 10");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><span class="badge badge-success"><?php echo"$row[1]"?></span></td>
                      ...
                      <td>
                      <?php if ($row[1]>28) {
                        echo "<i class='fa-solid fa-turn-up' style='color:#023c27'></i> HIGH";
                        }
                        elseif ($row[1]<26){
                          echo"<i class='fa-solid fa-level-down' style='color:#065c27'></i> LOW";}
                          else {
                          echo"<i class='fa-solid fa-temperature-full' style='color:#065c27'></i> GOOD";}
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Bjay-techs</a>.</strong>
